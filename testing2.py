...
monitoring = {"mean_squared_error": [], "accuracy": [], "epoch": []}
...
print(monitoring_df.loc[monitoring_df["mean_squared_error"] == 0.12314817925541241])
print("Neural network (1 hidden layers classification):")
print("epoch: 14999")
